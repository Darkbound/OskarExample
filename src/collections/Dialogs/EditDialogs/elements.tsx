...
export const StyledEditDialog = styled((props: DialogProps) => <Dialog {...props} />)``;

export const EditDepartmentDialogTitle = styled((props: DialogTitleProps) => (
  <DialogTitle {...props} />
))``;

export const TypographyTitle = styled((props: TypographyProps) => <Typography {...props} />)``;

export const EditDepartmenDialogContent = styled((props: DialogContentProps) => (
  <DialogContent {...props} />
))``;
